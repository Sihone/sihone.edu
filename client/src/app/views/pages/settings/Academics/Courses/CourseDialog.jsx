...
const ProgramDialog = ({ open, onClose, save, update, course, t, employees, programs, academic_years }) => {
  ...
  const disableSubmitButton = () => {
    return !name_en || !name_fr || selectedPrograms.length === 0 || !coefficient || !description || !employee;
  }
